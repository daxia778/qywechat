...
func InitDB() {
	...
	// 自动建表与迁移
	if err := DB.AutoMigrate(&Employee{}, &Order{}, &Customer{}, &AuditLog{}, &WecomGroupChat{}, &WecomMember{}, &WecomMessageLog{}, &AppVersion{}, &Notification{}, &OrderTimeline{}, &PaymentRecord{}, &TokenBlacklist{}, &UserMinIssuedAtRecord{}, &FreelanceDesigner{}, &ContactWay{}, &WelcomeTemplate{}, &AutomationTask{}); err != nil {
