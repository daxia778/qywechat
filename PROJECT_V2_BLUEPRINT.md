...
| # | 任务 | 预估 | 依赖 |
|:---:|:---|:---:|:---|
| 16 | 欢迎语自动发送 | 0.5d | Phase 4 #2 |
| 17 | Design Token统一（100+处批量替换） | 2h | — |
| 18 | 组件库落地（Dashboard/Orders/Employees） | 1d | #17 |
| 19 | 表格基础样式 + 响应式 | 1d | — |
| 20 | KPI骨架屏 + Loading优化 | 0.5d | — |
| 21 | N+1查询优化 + Dashboard SQL聚合 | 1d | — |
| 22 | WebSocket连接数上限 | 0.5d | — |
