...
export const NAV_GROUPS = [
  { key: 'core',   label: '核心业务', defaultOpen: true },
  { key: 'team',   label: '团队管理', defaultOpen: true },
  { key: 'system', label: '系统工具', defaultOpen: false },
];
...
export const NAV_ROUTES = [
  ...
  },
  {
    ...
    roles: ['admin'],
    group: 'team',
    icon: NavIcon({ d: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z' }),
  },
  {
    path: '/designers',
    title: '设计师花名册',
  ...
  },
  {
    ...
    roles: ['admin'],
    group: 'team',
    icon: NavIcon({ d: 'M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5' }),
  },
  {
    path: '/risk-center',
    title: '风控中心',
